...
public class LogicaDelJuego {
    ...
    public void mostrarGanador(int nroDeFichaGanadora){
        ...
        JOptionPane.showMessageDialog(null, nombreDelGanador , "PUM!!!", JOptionPane.WARNING_MESSAGE);
    }
    ...
    public int buscarGanadorDeFormaHorizontal(){
        return this.tablero.devolverFichaGanadoraPorFila();
    }
    
    public int buscarGanardorDeFormaVertical(){
        return this.tablero.devolverFichaGanadoraPorColumna();
    }
    
    public int buscarGanadorDeFormaDiagonal(){
        return this.tablero.devolverFichaGanadoraPorDiagonal();
    }
