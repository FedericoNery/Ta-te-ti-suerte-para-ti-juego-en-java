...
public class Jugador {
    ...
    public void determinarTurno(){
        if(this.turnosRestantes == 5){
            this.setArrancaPrimero(true);
        }
        else{
            this.setArrancaPrimero(false);
        }
    }
        ...
        if(!this.seAcabaronLosTurnos()){
            do{
                ...
                switch(numeroDeCasillero)
                {
                    ...
                    case(10): fila = 2; columna = 2 ; break;
                }
    ...
    public boolean esValidaLaCoordenada(String coordenada){
        if(coordenada.length() == 3 && coordenada.indexOf("-") == 1){
            if((coordenada.charAt(0) == '0' || coordenada.charAt(0) == '1' || coordenada.charAt(0) == '2')&&
