...
public class Tablero {
    ...
    public void mostrarTablero(){
        String lineaSuperior = "_______";
        System.out.println(lineaSuperior);
        for(int i=0;i < 3; i++){
            System.out.println("|"+ this.tablero[i][0] + "|" + this.tablero[i][1] + "|" + this.tablero[i][2] +"|");
        }
        System.out.println(lineaSuperior);
    }
    
    public String devolverTableroEnString(){
        String dibujoTablero = "      |C0 |C1 |C2 \n";
        for(int i=0;i < 3; i++){
            dibujoTablero = dibujoTablero + ("F"+ i + " |  "+ this.tablero[i][0] + "  |  " + this.tablero[i][1] + "  |  " + this.tablero[i][2] +"  |\n");
        }
        return dibujoTablero;
    }
